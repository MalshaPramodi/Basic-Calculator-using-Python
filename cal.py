...
class Calculator:
    def __init__(self):
        ...
        #Create the display frame and the button frame
        self.display_frame = self.create_display_frame()
        self.buttons_frame = self.create_buttons_frame()
       
       #Create labels to display expressions
        self.total_label, self.label = self.create_display_label()
        
        # Define digit buttons layout
        self.digits = {
            7:(1,1), 8:(1,2), 9:(1,3),
            4:(2,1), 5:(2,2), 6:(2,3),
            1:(3,1), 2:(3,2), 3:(3,3),
        ...
        #Configure the button frame layout
        self.buttons_frame.rowconfigure(0, weight=1)
        for x in range(1, 5):
            self.buttons_frame.rowconfigure(x, weight=1)
            self.buttons_frame.columnconfigure(x, weight=1)
            
        #Create buttons and bind keyboard events
    ...
    def bind_keys(self):
        ...
        self.window.bind("<Key-BackSpace>", lambda event: self.clear())
    
    #Special functions buttons: Clear, Equals, Sqrt, Sqr        
    ...
    #Create two labels: For Total Expression and for Current Expression    
    def create_display_label(self):
        total_label = tk.Label(self.display_frame, text=self.total_expression, anchor=tk.E, bg = LIGHT_GREY, fg = LABEL_COLOR, padx=24, font = FONT_STYLE)     
    ...
    #Create frame for the display labels    
    def create_display_frame(self):
        frame = tk.Frame(self.window, height = 223, bg = LIGHT_GREY)
    ...
    #Evaluate the total expression and update the result
    def evaluate(self):
        self.total_expression += self.current_expression
        self.update_total_label()
